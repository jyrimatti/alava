...
subst (Just name) param (ESigma t Nothing Nothing) = ESigma t Nothing Nothing
subst (Just name) param (ESigma t (Just y) Nothing) = ESigma t (Just (subst (Just name) param y)) Nothing
subst (Just name) param (ESigma t (Just y) (Just z)) = ESigma t (Just (subst (Just name) param y)) (Just (subst (Just name) param z))
